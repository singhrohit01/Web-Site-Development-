 ...
 */
@WebServlet("/AddAddressProfileController")
public class AddAddressProfileController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		if (result.equals("fillFields")) {
			...
			out.print("</div>");
			RequestDispatcher rd = request.getRequestDispatcher("AddAddressProfile.html");
			...
			out.print("<div class=\"alert\">");
			out.print("<span class=\"closebtn\" onclick=\"this.parentElement.style.display='none';\">&times;</span> "
					+ "<font>You may add another address or click cancel to return to profile</font>");
			out.print("</div>");
			RequestDispatcher rd = request.getRequestDispatcher("AddAddressProfile.html");
			rd.include(request, response);
		}
