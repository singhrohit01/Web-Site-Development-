...
public class AddCardController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result.equals("fillFields")){
			...
			out.print("</div>");
			RequestDispatcher rd = request.getRequestDispatcher("AddCard.html");
			...
			try{
				...
				out.println("<p style='color:black;'>Account successfully created, <b>confirm the email sent to login!</b><br>Please wait while you are being redirected...</p>");
			}catch(Exception e){
				e.printStackTrace();
			}
		}
